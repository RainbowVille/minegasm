...
public class ConfigScreen extends Screen {
    ...
    @Override
    protected void init() {
        wsHost = new TextFieldWidget(Minecraft.getInstance().fontRenderer, this.width / 2 - 100, this.height / 6, 200, 20, "ws://localhost:12345");
        wsHost.setText(MinegasmConfig.serverUrl);
        this.addButton(wsHost);
        
        wsHost.func_212954_a(s -> { // Set responder function
            LOGGER.info(s);
            MinegasmConfig.serverUrl = s;
		});
        
        this.addButton(new GuiButtonExt(
        ...
        Button reconnectButton = new GuiButtonExt(
        ...
        this.addButton(new GuiButtonExt(this.width / 2 - 155, this.height / 6 + 25 * 3, 150, 20,
        ...
        this.addButton(new GuiButtonExt(this.width / 2 + 5, this.height / 6 + 25 * 3, 150, 20,
        ...
        this.addButton(new GuiButtonExt(this.width / 2 - 155, this.height / 6 + 25 * 4, 150, 20,
        ...
        this.addButton(new GuiButtonExt(
            ...
            ("Edit Custom Settings"), button ->  minecraft.displayGuiScreen(new CustomModeConfigScreen(this, pauseMenu))));

        this.addButton(new GuiButtonExt(this.width / 2 - 100, this.height / 6 + 25 * 5, 200, 20,
