...
public class ForgeSlider extends AbstractSlider
{
     ...
     * @param prefix {@link String} displayed before the value string
     * @param suffix {@link String} displayed after the value string
     ...
     */
    public ForgeSlider(int x, int y, int width, int height, String prefix, String suffix, double minValue, double maxValue, double currentValue, double stepSize, int precision, boolean drawString)
    {
        ...
        else if (this.stepSize == Math.floor(this.stepSize))
        {
     ...
     */
    public ForgeSlider(int x, int y, int width, int height, String prefix, String suffix, double minValue, double maxValue, double currentValue, boolean drawString)
    {
...
//        return MathHelper.map(value, this.minValue, this.maxValue, 0D, 1D);
    ...
    protected void updateMessage()
    {
        if (this.drawString)
        {
            this.setMessage(prefix + this.getValueString() + suffix);
        }
        else
        {
            this.setMessage("");
