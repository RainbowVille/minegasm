...
//        ConfigHolder.CLIENT.serverUrl.set(DEFAULT_SERVER_URL);
        ConfigHelper.setConfigValue(ConfigHolder.CLIENT.serverUrl.getPath(), DEFAULT_SERVER_URL);
    }
    
    public void resetConfigCustom()
    {
        ConfigHelper.setConfigValue(ConfigHolder.CLIENT.attackIntensity.getPath(), DEFAULT_ATTACK_INTENSITY);
        ConfigHelper.setConfigValue(ConfigHolder.CLIENT.hurtIntensity.getPath(), DEFAULT_HURT_INTENSITY);
        ConfigHelper.setConfigValue(ConfigHolder.CLIENT.mineIntensity.getPath(), DEFAULT_MINE_INTENSITY);
        ConfigHelper.setConfigValue(ConfigHolder.CLIENT.placeIntensity.getPath(), DEFAULT_PLACE_INTENSITY);
        ConfigHelper.setConfigValue(ConfigHolder.CLIENT.xpChangeIntensity.getPath(), DEFAULT_XP_CHANGE_INTENSITY);
        ConfigHelper.setConfigValue(ConfigHolder.CLIENT.fishingIntensity.getPath(), DEFAULT_FISHING_INTENSITY);
        ConfigHelper.setConfigValue(ConfigHolder.CLIENT.harvestIntensity.getPath(), DEFAULT_HARVEST_INTENSITY);
        ConfigHelper.setConfigValue(ConfigHolder.CLIENT.vitalityIntensity.getPath(), DEFAULT_VITALITY_INTENSITY);
        ConfigHelper.setConfigValue(ConfigHolder.CLIENT.advancementIntensity.getPath(), DEFAULT_ADVANCEMENT_INTENSITY);
    }
