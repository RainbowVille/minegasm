...
public abstract class AbstractVibrationState
{
    ...
    public static int getIntensity(String type) {
        ...
        {
            case NORMAL: returnValue = normal.get(type); break;
            case MASOCHIST: returnValue = masochist.get(type); break;
            case HEDONIST: returnValue = hedonist.get(type); break;
            case ACCUMULATION: returnValue = accumulation.get(type); break;
            case CUSTOM: returnValue = custom.get(type); break;
        };
